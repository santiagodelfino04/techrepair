    ...
    <div className="public-page">
      ...
      <section id="galeria" style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        <div className="gallery-grid">
          {[
            { src: '/galeria/foto1.jpg', alt: 'Reparación bajo microscopio' },
            { src: '/galeria/foto2.jpg', alt: 'Desmontaje y cambio de cámara' },
            { src: '/galeria/foto3.jpg', alt: 'Interior — cambio de tapa trasera' },
            { src: '/galeria/foto4.jpg', alt: 'Tapa trasera — antes' },
            { src: '/galeria/foto5.jpg', alt: 'Tapa trasera — después' },
            { src: '/galeria/foto6.jpg', alt: 'Equipo listo para entrega' },
          ].map((foto, i) => (
